...
export class FeishuNotifier{
  ...
  async send(input:Row){
    const binding=this.binding(input.chatId),text=typeof input.text==='string'?input.text.trim():'',format=input.format==='card'?'card':'text';
