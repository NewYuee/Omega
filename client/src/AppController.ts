...
const groupUI=initGroups({getKey:()=>key,api,rpc,error,pastedText,closeDrawer:()=>window.omegaReactWorkspace?.closeSidebar(),getWorkspace:()=>session.snapshot.serverWorkspace,openDialog,
